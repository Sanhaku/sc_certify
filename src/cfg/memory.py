...
from src.cfg.evm.exceptions import TimeoutException
...
def get_memory_info(ins, code, memory_infos=None):
    from src.cfg.slicing import backward_slice, slice_to_program
    from src.cfg.evm.evm import run
    from src.cfg.evm.state import EVMState
    from src.cfg.evm.exceptions import ExternalData
    from src.cfg.util.intrange import Range
    targets = []
